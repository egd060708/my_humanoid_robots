...
namespace
{
    ...
    public:
        ...
        inline void bindEulerCoordinate(EulerCoordinate_t _ideal_Pitch, EulerCoordinate_t _ideal_Yaw, EulerCoordinate_t _ideal_Roll)
        {
...
private:
    ...
    virtual float getEularPitch()
    {
        return imu->get_data().Euler_Pitch;
    }
    virtual float getEularYaw()
    {
        return imu->get_data().Euler_Yaw;
    }
    virtual float getEularRoll()
    {
    ...
    /* yaw绑定caliGyroZ */
    /* roll绑定caliGyroX */
    virtual float getGyroPitch()
    {
        return imu->get_data().caliGyroY;
    }
    virtual float getGyroYaw()
    {
        return imu->get_data().caliGyroZ;
    }
    virtual float getGyroRoll()
    {
...
public:
    inline void bindIMU(Webots_Acc* _acc, Webots_Gyro* _gyro, Webots_IMU* _imu)
    {
        this->acc = _acc;
        this->gyro = _gyro;
        this->imu = _imu;
