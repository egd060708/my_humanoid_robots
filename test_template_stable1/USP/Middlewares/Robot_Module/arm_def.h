 ...
 */
template<uint8_t jNum>
inline void Arm_Def_s<jNum>::update_Space_c(const float _angle[jNum])
{
	//拷贝关节空间值,并更新DH参数矩阵
 ...
 */
template<uint8_t jNum>
inline myMatrices<float> Arm_Def_s<jNum>::fk()
{
 ...
 */
template<uint8_t jNum>
inline void Arm_Def_s<jNum>::set_spaceCali(const float _spaceCali[4 * 4])
{
